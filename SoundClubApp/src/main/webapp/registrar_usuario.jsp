	...
	<section class="muro">
		<form action="" method="POST" class="action" id="formulario">
			...
			<label>Nombre<input type="text" placeholder="&#128272;"
				name="nombre" id="usuario" value="Isaac" required></label> 
				<label>Apellidos<input
				type="text" placeholder="&#128272;" name="apellidos" id="Apellidos" value="Mesa"
				required></label> 
				<label>Email<input id="emailsignup" value="i@is.es"
				name="emailsignup" type="email" placeholder="&#128272;" required></label> 
				<label>Contrasena<input type="password" id="passwordsignup" value="12345"
				...
				required="required" type="password" placeholder="&#128272;" value="12345"/></label> 
				<input id="btnEnviar" type="submit" value="registro"></input>
